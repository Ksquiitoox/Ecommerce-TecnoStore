document.addEventListener("DOMContentLoaded", () => {
  ...
  // Scroll dinámico según ancho de tarjeta
  const cardWidth = slider.querySelector(".product-card").offsetWidth + 20; // 20 = gap
  prevBtn.onclick = () => slider.scrollBy({ left: -cardWidth, behavior: "smooth" });
  nextBtn.onclick = () => slider.scrollBy({ left: cardWidth, behavior: "smooth" });
});
